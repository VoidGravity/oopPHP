        ...
        <aside id="sidebar" class="side">
            <div class="h-100">
                <div class="sidebar_logo d-flex align-items-end">
                    ...
                    <a href="<?= url("dashboard")?>" class="nav-link text-white-50">Dashboard</a>
                    <img class="close align-self-start" src="<?= ABS_URL_dash ?>img/close.svg" alt="icon">
                </div>
                ...
                <div class="line"></div>
                <a href="#" class="sidebar_link"><img src="<?= ABS_URL_dash ?>img/settings.svg" alt="icon">Settings</a>
                        ...
                        <div class="card">
                            <div class="card-body  p-4">
                                <div class="d-flex justify-content-between px-md-1">
                                    ...
                                    <div class="cursor">
                                        <img src="<?= ABS_URL_dash ?>img/project-icon-1.svg" alt="icon">
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="d-flex justify-content-between px-md-1">
                                    ...
                                    <div class="">
                                        <img src="<?= ABS_URL_dash ?>img/project-icon-2.svg" alt="icon">
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="d-flex justify-content-between px-md-1">
                                    ...
                                    <div class="">
                                        <img src="<?= ABS_URL_dash ?>img/project-icon-3.svg" alt="icon">
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="d-flex justify-content-between px-md-1">
                                    ...
                                    <div class="">
                                        <img src="<?= ABS_URL_dash ?>img/project-icon-4.svg" alt="icon">
                                    </div>
                                </div>
                ...
                <div class="card">
                    ...
                    <div class="Admin_task list-group">
                        <div class="list-group-item px-3 text d-flex justify-content-between align-items-center p-4">
                            ...
                            <img class="cursor " id="add_admin_task" src="<?= ABS_URL_dash ?>img/inactive.svg" alt="icon">
                        </div>
                        <div class="list-group-item px-3 text d-flex justify-content-between align-items-center p-4">
                            <p>Finish offre update</p>
                            <img src="<?= ABS_URL_dash ?>img/warning.svg" alt="icon">
                        </div>
                        <div class="list-group-item px-3 text d-flex justify-content-between align-items-center p-4">
                            <p>Create new offre example</p>
                            <img src="<?= ABS_URL_dash ?>img/successnew.svg" alt="icon">
                        </div>
                        <div class="list-group-item px-3 text d-flex justify-content-between align-items-center p-4">
                            <p>Update offre report</p>
                            <img src="<?= ABS_URL_dash ?>img/default.svg" alt="icon">
                        </div>
                    </div>
                </div>
            </div>
